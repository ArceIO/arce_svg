...
/// The class for ArceSvgData that the code generator will implement
class ArceSvgData {
  /// The svg data
  const ArceSvgData(
    this.path,
  ...
  /// The path to the svg data in indie_game assets/images
  final String path;
}
...
class ArceSvg extends StatelessWidget {
  /// Construct ArceSvg Widget
  const ArceSvg(
    this.svg, {
    super.key,
    this.size,
  ...
  /// The data for the arce svg. Will be generated by the generator in this
  /// package within bin/arce_svg.dart
  final ArceSvgData svg;
