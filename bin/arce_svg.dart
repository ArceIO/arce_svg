...
/// Generate the abstract class for the ArceSvg data.
...
String lineFor(File file, Options options) {
  ...
  return "  static const $name = ArceSvgData('${pathFor(file)}');";
}
